...
public class OutOrderDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (datas.get(position).getDepotNo().equals(depot.getDepotNo()) && datas.get(position).getFinishStatus().equals("1")) {
            if (datas.get(position).getActCount() == null) {
                ...
                if ((float) datas.get(position).getCount() > Float.valueOf(datas.get(position).getActCount())) {
                    ((MyViewHolder) holder).good.setTextColor(Color.BLUE);
                    ((MyViewHolder) holder).modle.setTextColor(Color.BLUE);
                    ((MyViewHolder) holder).count.setTextColor(Color.BLUE);
                    ((MyViewHolder) holder).customerName.setTextColor(Color.BLUE);
